        ...
        <div style={{
          ...
          {products.map(product => (
            <Link key={product.id} href={`/product/${product.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
              <div
                style={{ border: '1px solid #222', borderRadius: '12px', overflow: 'hidden', cursor: 'pointer' }}
              ...
              >
                ...
                <div style={{ padding: '16px' }}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <span style={{ background: '#fff', color: '#000', padding: '6px 14px', borderRadius: '20px', fontSize: '12px', fontWeight: '700' }}>VIEW</span>
                  </div>
                </div>
              </div>
            </Link>
